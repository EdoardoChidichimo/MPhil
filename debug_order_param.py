...
for i, freq_std in value_range:
    ...
    for j, phase_noise in value_range:
        ...
        for k, cintra in enumerate(sorted(cintra_R_values.keys())):
            ax.plot(cintra_R_values[cintra], label=f'cintra = {cintra}', color=colors[k], linewidth=0.05)
...
figures_dir = "debug_order_param_results/result_figures"
os.makedirs(figures_dir, exist_ok=True)
filename = "combined_R_over_time.png"
