...
#data.shape (2, n_epochs, n_channels, n_freq_bands, n_times) ==> (2, n_epochs, n_channels, n_times)
data = analyses.compute_freq_bands(data_inter, sampling_rate, freq_bands)
